 ...
 * A PlanetScale database password.
 */
export function getPasswordOutput(args: GetPasswordOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPasswordResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("planetscale:index/getPassword:getPassword", {
        "branch": args.branch,
        "database": args.database,
        "id": args.id,
        "organization": args.organization,
