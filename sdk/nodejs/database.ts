...
export class Database extends pulumi.CustomResource {
   ...
   */
  public readonly /*out*/ atBackupRestoreBranchesLimit!: pulumi.Output<boolean>;
  /**
   * If the database has reached its development branch limit.
   */
  public readonly /*out*/ atDevelopmentBranchLimit!: pulumi.Output<boolean>;
  /**
   ...
   */
  public readonly /*out*/ branchesCount!: pulumi.Output<number>;
  /**
   * The URL to retrieve this database's branches via the API.
   */
  public readonly /*out*/ branchesUrl!: pulumi.Output<string>;
  /**
   ...
   */
  public readonly /*out*/ dataImport!: pulumi.Output<outputs.DatabaseDataImport>;
  /**
   ...
   */
  public readonly /*out*/ defaultBranchReadOnlyRegionsCount!: pulumi.Output<number>;
  /**
   * Number of shards in the default branch.
   */
  public readonly /*out*/ defaultBranchShardCount!: pulumi.Output<number>;
  /**
   * Number of tables in the default branch schema.
   */
  public readonly /*out*/ defaultBranchTableCount!: pulumi.Output<number>;
  /**
   * The total number of database development branches.
   */
  public readonly /*out*/ developmentBranchesCount!: pulumi.Output<number>;
  /**
   * The total number of database development branches.
   */
   ...
   */
  public readonly /*out*/ productionBranchesCount!: pulumi.Output<number>;
  /**
   ...
   */
  public readonly /*out*/ state!: pulumi.Output<string>;
  /**
  ...
  constructor(
    ...
    if (opts.id) {
      ...
      resourceInputs["allowDataBranching"] = state
        ? state.allowDataBranching
        : undefined;
      resourceInputs["atBackupRestoreBranchesLimit"] = state
        ? state.atBackupRestoreBranchesLimit
        : undefined;
      resourceInputs["atDevelopmentBranchLimit"] = state
        ? state.atDevelopmentBranchLimit
        : undefined;
      resourceInputs["automaticMigrations"] = state
        ? state.automaticMigrations
        : undefined;
      ...
      resourceInputs["defaultBranchReadOnlyRegionsCount"] = state
        ? state.defaultBranchReadOnlyRegionsCount
        : undefined;
      resourceInputs["defaultBranchShardCount"] = state
        ? state.defaultBranchShardCount
        : undefined;
      resourceInputs["defaultBranchTableCount"] = state
        ? state.defaultBranchTableCount
        : undefined;
      resourceInputs["developmentBranchesCount"] = state
        ? state.developmentBranchesCount
        : undefined;
      resourceInputs["htmlUrl"] = state ? state.htmlUrl : undefined;
      resourceInputs["insightsRawQueries"] = state
        ? state.insightsRawQueries
        : undefined;
      resourceInputs["issuesCount"] = state ? state.issuesCount : undefined;
      resourceInputs["migrationFramework"] = state
        ? state.migrationFramework
        : undefined;
      resourceInputs["migrationTableName"] = state
        ? state.migrationTableName
        : undefined;
      resourceInputs["multipleAdminsRequiredForDeletion"] = state
        ? state.multipleAdminsRequiredForDeletion
        : undefined;
      resourceInputs["name"] = state ? state.name : undefined;
      resourceInputs["organization"] = state ? state.organization : undefined;
      resourceInputs["plan"] = state ? state.plan : undefined;
      resourceInputs["productionBranchWebConsole"] = state
        ? state.productionBranchWebConsole
        : undefined;
      resourceInputs["productionBranchesCount"] = state
        ? state.productionBranchesCount
        : undefined;
      resourceInputs["ready"] = state ? state.ready : undefined;
      resourceInputs["region"] = state ? state.region : undefined;
      resourceInputs["requireApprovalForDeploy"] = state
        ? state.requireApprovalForDeploy
        : undefined;
      resourceInputs["restrictBranchRegion"] = state
        ? state.restrictBranchRegion
        : undefined;
      ...
      resourceInputs["allowDataBranching"] = args
        ? args.allowDataBranching
        : undefined;
      resourceInputs["automaticMigrations"] = args
        ? args.automaticMigrations
        : undefined;
      resourceInputs["clusterSize"] = args ? args.clusterSize : undefined;
      resourceInputs["defaultBranch"] = args ? args.defaultBranch : undefined;
      resourceInputs["insightsRawQueries"] = args
        ? args.insightsRawQueries
        : undefined;
      resourceInputs["issuesCount"] = args ? args.issuesCount : undefined;
      resourceInputs["migrationFramework"] = args
        ? args.migrationFramework
        : undefined;
      resourceInputs["migrationTableName"] = args
        ? args.migrationTableName
        : undefined;
      resourceInputs["multipleAdminsRequiredForDeletion"] = args
        ? args.multipleAdminsRequiredForDeletion
        : undefined;
      resourceInputs["name"] = args ? args.name : undefined;
      resourceInputs["organization"] = args ? args.organization : undefined;
      resourceInputs["plan"] = args ? args.plan : undefined;
      resourceInputs["productionBranchWebConsole"] = args
        ? args.productionBranchWebConsole
        : undefined;
      resourceInputs["region"] = args ? args.region : undefined;
      resourceInputs["requireApprovalForDeploy"] = args
        ? args.requireApprovalForDeploy
        : undefined;
      resourceInputs["restrictBranchRegion"] = args
        ? args.restrictBranchRegion
        : undefined;
