...
export class Backup extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly backupPolicy!: pulumi.Output<outputs.BackupBackupPolicy>;
    /**
     ...
     */
    public /*out*/ readonly estimatedStorageCost!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly retentionValue!: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: BackupArgs | BackupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["retentionValue"] = state ? state.retentionValue : undefined;
            ...
            if ((!args || args.retentionUnit === undefined) && !opts.urn) {
                throw new Error("Missing required property 'retentionUnit'");
            }
            if ((!args || args.retentionValue === undefined) && !opts.urn) {
            ...
            resourceInputs["retentionValue"] = args ? args.retentionValue : undefined;
