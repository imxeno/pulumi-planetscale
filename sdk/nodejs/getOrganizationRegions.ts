 ...
 * ```
 */
export function getOrganizationRegionsOutput(args: GetOrganizationRegionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrganizationRegionsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("planetscale:index/getOrganizationRegions:getOrganizationRegions", {
        "organization": args.organization,
    }, opts);
}
