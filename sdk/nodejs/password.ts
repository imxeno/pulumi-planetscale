...
export class Password extends pulumi.CustomResource {
   ...
   */
  public readonly /*out*/ accessHostUrl!: pulumi.Output<string>;
  /**
   * The actor that created this branch.
   */
  public readonly /*out*/ actor!: pulumi.Output<outputs.PasswordActor>;
  /**
   ...
   */
  public readonly /*out*/ databaseBranch!: pulumi.Output<outputs.PasswordDatabaseBranch>;
  /**
   * When the password was deleted.
   */
  public readonly /*out*/ deletedAt!: pulumi.Output<string>;
  /**
   * When the password will expire.
   */
  public readonly /*out*/ expiresAt!: pulumi.Output<string>;
  /**
   ...
   */
  public readonly /*out*/ plaintext!: pulumi.Output<string>;
  /**
   * The region in which this password can be used.
   */
  public readonly /*out*/ region!: pulumi.Output<outputs.PasswordRegion>;
  /**
   * Whether or not the password can be renewed.
   */
  public readonly /*out*/ renewable!: pulumi.Output<boolean>;
  /**
   ...
   */
  public readonly /*out*/ username!: pulumi.Output<string>;
  ...
  constructor(
    ...
    if (opts.id) {
      ...
      resourceInputs["databaseBranch"] = state
        ? state.databaseBranch
        : undefined;
