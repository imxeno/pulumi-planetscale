...
namespace Pulumi.Planetscale.Inputs
{
    ...
    public sealed class DatabaseDataImportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Connection information for the source of the data for the import.
        /// </summary>
        [Input("dataSource")]
        public Input<Inputs.DatabaseDataImportDataSourceArgs>? DataSource { get; set; }
        ...
        public DatabaseDataImportArgs()
        {
        }
        public static new DatabaseDataImportArgs Empty => new DatabaseDataImportArgs();
    }
}
