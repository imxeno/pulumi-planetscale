...
func GetOrganizationRegionsOutput(ctx *pulumi.Context, args GetOrganizationRegionsOutputArgs, opts ...pulumi.InvokeOption) GetOrganizationRegionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOrganizationRegionsResultOutput, error) {
			args := v.(GetOrganizationRegionsArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("planetscale:index/getOrganizationRegions:getOrganizationRegions", args, GetOrganizationRegionsResultOutput{}, options).(GetOrganizationRegionsResultOutput), nil
