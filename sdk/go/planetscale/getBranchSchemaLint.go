...
func GetBranchSchemaLintOutput(ctx *pulumi.Context, args GetBranchSchemaLintOutputArgs, opts ...pulumi.InvokeOption) GetBranchSchemaLintResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBranchSchemaLintResultOutput, error) {
			args := v.(GetBranchSchemaLintArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("planetscale:index/getBranchSchemaLint:getBranchSchemaLint", args, GetBranchSchemaLintResultOutput{}, options).(GetBranchSchemaLintResultOutput), nil
