...
func GetPasswordsOutput(ctx *pulumi.Context, args GetPasswordsOutputArgs, opts ...pulumi.InvokeOption) GetPasswordsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetPasswordsResultOutput, error) {
			args := v.(GetPasswordsArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("planetscale:index/getPasswords:getPasswords", args, GetPasswordsResultOutput{}, options).(GetPasswordsResultOutput), nil
