...
type GetBackupsBackup struct {
	...
	EstimatedStorageCost float64 `pulumi:"estimatedStorageCost"`
...
type GetBackupsBackupArgs struct {
	...
	Database pulumi.StringInput `pulumi:"database"`
	// The estimated storage cost of the backup.
	EstimatedStorageCost pulumi.Float64Input `pulumi:"estimatedStorageCost"`
	// The ID of the backup.
	Id pulumi.StringInput `pulumi:"id"`
	// The name of the backup.
	Name pulumi.StringInput `pulumi:"name"`
...
// The estimated storage cost of the backup.
func (o GetBackupsBackupOutput) EstimatedStorageCost() pulumi.Float64Output {
	return o.ApplyT(func(v GetBackupsBackup) float64 { return v.EstimatedStorageCost }).(pulumi.Float64Output)
}
...
type GetUserDefaultOrganization struct {
	// When the organization was created.
	CreatedAt string `pulumi:"createdAt"`
...
// GetUserDefaultOrganizationInput is an input type that accepts GetUserDefaultOrganizationArgs and GetUserDefaultOrganizationOutput values.
// You can construct a concrete instance of `GetUserDefaultOrganizationInput` via:
//
//	GetUserDefaultOrganizationArgs{...}
type GetUserDefaultOrganizationInput interface {
	pulumi.Input

	ToGetUserDefaultOrganizationOutput() GetUserDefaultOrganizationOutput
	ToGetUserDefaultOrganizationOutputWithContext(context.Context) GetUserDefaultOrganizationOutput
}

type GetUserDefaultOrganizationArgs struct {
	// When the organization was created.
	CreatedAt pulumi.StringInput `pulumi:"createdAt"`
	// When the organization was last deleted.
	DeletedAt pulumi.StringInput `pulumi:"deletedAt"`
...
func (GetUserDefaultOrganizationArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetUserDefaultOrganization)(nil)).Elem()
}

func (i GetUserDefaultOrganizationArgs) ToGetUserDefaultOrganizationOutput() GetUserDefaultOrganizationOutput {
	return i.ToGetUserDefaultOrganizationOutputWithContext(context.Background())
}

func (i GetUserDefaultOrganizationArgs) ToGetUserDefaultOrganizationOutputWithContext(ctx context.Context) GetUserDefaultOrganizationOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetUserDefaultOrganizationOutput)
}

type GetUserDefaultOrganizationOutput struct{ *pulumi.OutputState }

func (GetUserDefaultOrganizationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetUserDefaultOrganization)(nil)).Elem()
}

func (o GetUserDefaultOrganizationOutput) ToGetUserDefaultOrganizationOutput() GetUserDefaultOrganizationOutput {
	return o
}

func (o GetUserDefaultOrganizationOutput) ToGetUserDefaultOrganizationOutputWithContext(ctx context.Context) GetUserDefaultOrganizationOutput {
	return o
}

// When the organization was created.
func (o GetUserDefaultOrganizationOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserDefaultOrganization) string { return v.CreatedAt }).(pulumi.StringOutput)
}

// When the organization was last deleted.
func (o GetUserDefaultOrganizationOutput) DeletedAt() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserDefaultOrganization) string { return v.DeletedAt }).(pulumi.StringOutput)
}

// The ID of the organization.
func (o GetUserDefaultOrganizationOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserDefaultOrganization) string { return v.Id }).(pulumi.StringOutput)
}

// The name of the organization.
func (o GetUserDefaultOrganizationOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserDefaultOrganization) string { return v.Name }).(pulumi.StringOutput)
}

// When the organization was last updated.
func (o GetUserDefaultOrganizationOutput) UpdatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserDefaultOrganization) string { return v.UpdatedAt }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserDefaultOrganizationInput)(nil)).Elem(), GetUserDefaultOrganizationArgs{})
	...
	pulumi.RegisterOutputType(GetUserDefaultOrganizationOutput{})
}
