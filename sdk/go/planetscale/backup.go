...
type Backup struct {
	...
	EstimatedStorageCost pulumi.Float64Output `pulumi:"estimatedStorageCost"`
	...
	RetentionUnit pulumi.StringOutput `pulumi:"retentionUnit"`
	// A number value for the retention period of the backup policy.
	RetentionValue pulumi.Float64Output `pulumi:"retentionValue"`
...
func NewBackup(ctx *pulumi.Context,
	...
	if args.RetentionUnit == nil {
		return nil, errors.New("invalid value for required argument 'RetentionUnit'")
	}
	if args.RetentionValue == nil {
		return nil, errors.New("invalid value for required argument 'RetentionValue'")
	}
...
type BackupState struct {
	...
	// The estimated storage cost of the backup.
	EstimatedStorageCost pulumi.Float64PtrInput
	// The name of the backup.
	...
	// The unit for the retention period of the backup policy.
	RetentionUnit pulumi.StringPtrInput
	// A number value for the retention period of the backup policy.
	RetentionValue pulumi.Float64PtrInput
	// The size of the backup.
...
type BackupArgs struct {
	...
	// The unit for the retention period of the backup policy.
	RetentionUnit pulumi.StringInput
	// A number value for the retention period of the backup policy.
	RetentionValue pulumi.Float64Input
}
...
// The estimated storage cost of the backup.
func (o BackupOutput) EstimatedStorageCost() pulumi.Float64Output {
	return o.ApplyT(func(v *Backup) pulumi.Float64Output { return v.EstimatedStorageCost }).(pulumi.Float64Output)
}
...
// The unit for the retention period of the backup policy.
func (o BackupOutput) RetentionUnit() pulumi.StringOutput {
	return o.ApplyT(func(v *Backup) pulumi.StringOutput { return v.RetentionUnit }).(pulumi.StringOutput)
}

// A number value for the retention period of the backup policy.
func (o BackupOutput) RetentionValue() pulumi.Float64Output {
	return o.ApplyT(func(v *Backup) pulumi.Float64Output { return v.RetentionValue }).(pulumi.Float64Output)
}
