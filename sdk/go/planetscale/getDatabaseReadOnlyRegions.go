...
//				return err
//			}
//			ctx.Export("databaseRoRegions", examplePlanetscaleDatabaseRegions)
//			return nil
//		})
//	}
//
...
func GetDatabaseReadOnlyRegionsOutput(ctx *pulumi.Context, args GetDatabaseReadOnlyRegionsOutputArgs, opts ...pulumi.InvokeOption) GetDatabaseReadOnlyRegionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDatabaseReadOnlyRegionsResultOutput, error) {
			args := v.(GetDatabaseReadOnlyRegionsArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("planetscale:index/getDatabaseReadOnlyRegions:getDatabaseReadOnlyRegions", args, GetDatabaseReadOnlyRegionsResultOutput{}, options).(GetDatabaseReadOnlyRegionsResultOutput), nil
