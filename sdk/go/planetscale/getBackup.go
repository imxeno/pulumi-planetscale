...
func LookupBackupOutput(ctx *pulumi.Context, args LookupBackupOutputArgs, opts ...pulumi.InvokeOption) LookupBackupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupBackupResultOutput, error) {
			...
			return ctx.InvokeOutput("planetscale:index/getBackup:getBackup", args, LookupBackupResultOutput{}, options).(LookupBackupResultOutput), nil
...
// The estimated storage cost of the backup.
func (o LookupBackupResultOutput) EstimatedStorageCost() pulumi.Float64Output {
	return o.ApplyT(func(v LookupBackupResult) float64 { return v.EstimatedStorageCost }).(pulumi.Float64Output)
}
