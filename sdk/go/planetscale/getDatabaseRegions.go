...
func GetDatabaseRegionsOutput(ctx *pulumi.Context, args GetDatabaseRegionsOutputArgs, opts ...pulumi.InvokeOption) GetDatabaseRegionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetDatabaseRegionsResultOutput, error) {
			args := v.(GetDatabaseRegionsArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("planetscale:index/getDatabaseRegions:getDatabaseRegions", args, GetDatabaseRegionsResultOutput{}, options).(GetDatabaseRegionsResultOutput), nil
