...
def get_organizations(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationsResult:
    ...
    __ret__ = pulumi.runtime.invoke('planetscale:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult).value
...
def get_organizations_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrganizationsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('planetscale:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult)
